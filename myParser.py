...
class Parser():
    ...
    LiteralTokenID = ['Identifier', 'FloatingLiteral', 'HexadecimalLiteral', 'DecimalLiteral', 'OctalLiteral', 'BinaryLiteral', 'CharacterLiteral', 'BooleanLiteral', 'StringLiteral', 'MultiLineMacro', 'Directive']
